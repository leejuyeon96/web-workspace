...
<body>
	...
	<%--로그인 되었을 때 --%>	
		<li><a href="views/search.html">회원검색</a>
		
		<%--회원검색 : 검색할 아이디를 입력받아서 FindMemberServlet -> 검색 성공하면 views/find_ok.jsp (정보 출력) -> 실패하면 views/find_fail.jsp--%>
