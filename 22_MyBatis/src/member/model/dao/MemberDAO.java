...
public class MemberDAO{
	...
	public int registerMember(SqlSession sqlSession, MemberVO vo) {	// parameter값 있으니까 MemberVO
		return sqlSession.insert("memberMapper.registerMember", vo);	// namespace의 해당 아이디값+파라미터값 넘겨
